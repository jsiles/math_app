...
import { getRandomStatisticsQuestion } from '../services/statisticsService';
...
export default function StatisticsScreen() {
  ...
  const fetchQuestion = () => {
    setLoading(true);
    getRandomStatisticsQuestion((q: any) => {
      setQuestion(q);
      setLoading(false);
  ...
  return (
    <View style={styles.container}>
      <Button title="Get Statistics Question" onPress={fetchQuestion} />
      {mode && (
