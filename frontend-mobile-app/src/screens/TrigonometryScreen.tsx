...
import { getRandomTrigonometryQuestion } from '../services/trigonometryService';
...
export default function TrigonometryScreen() {
  ...
  const fetchQuestion = () => {
    setLoading(true);
    getRandomTrigonometryQuestion((q: any) => {
      setQuestion(q);
      setLoading(false);
  ...
  return (
    <View style={styles.container}>
      <Button title="Get Trigonometry Question" onPress={fetchQuestion} />
      {mode && (
